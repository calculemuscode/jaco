...
export function restrictStatement(lang: Lang, syn: Statement): ast.Statement {
    switch (syn.tag) {
        ...
        case "ErrorStatement": {
            if (lang === "L1" || lang === "L2" || lang === "L3" || lang === "L4") throw new Error(`The error statement is not a part of ${lang}`)
            return {
                tag: "ErrorStatement",
                argument: restrictExpression(lang, syn.argument)
            }
        ...
        case "BreakStatement": {
            if (lang !== "C1") throw new Error(`The statement 'break' is not a part of ${lang}`)
            return {
                tag: "BreakStatement"
            }
        }
        ...
        case "ContinueStatement": {
            if (lang !== "C1") throw new Error(`The statement 'continue' is not a part of ${lang}`)
            return {
